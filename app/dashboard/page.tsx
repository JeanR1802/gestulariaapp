    ...
    <div className="min-h-screen bg-slate-100">
      <div className="max-w-7xl mx-auto px-8 py-10">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Mis Sitios Web</h1>
          ...
          <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            {tenants.map((tenant) => (
              <div key={tenant.id} className="bg-white rounded-xl shadow-sm border group transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div className="h-28 bg-gray-50 rounded-t-xl flex items-center justify-center border-b">
                   <GlobeAltIcon className="h-10 w-10 text-gray-300 group-hover:text-blue-500 transition-colors" />
                </div>
