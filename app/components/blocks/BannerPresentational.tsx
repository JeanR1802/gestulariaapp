...
const BannerPresentational: React.FC<BlockComponentProps<any>> = ({ data }) => {
  ...
  return (
    <div className={`w-full ${data.height || 'h-12'} flex items-center px-4 shadow-sm gap-2 ${bgClass} ${alignClass}`} style={{ backgroundColor: data.bgStyle || undefined }}>
