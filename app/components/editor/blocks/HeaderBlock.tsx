...
import { HeaderData as HeaderDataType } from './Header/HeaderVariantDefault';

// Exportamos la interfaz para que el registro la pueda usar
export type HeaderData = HeaderDataType;

// El formulario de edición es el mismo para todas las variantes
