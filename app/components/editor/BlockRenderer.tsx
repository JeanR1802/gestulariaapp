// Archivo: src/app/components/editor/BlockRenderer.tsx
'use client';

import React from 'react';
import { BLOCKS, HeroData, TextData, ImageData, CardsData, CtaData, FooterData, HeaderData, BlockData } from './blocks';
